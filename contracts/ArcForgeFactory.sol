...
/// @notice ArcOrigin direct-to-Uniswap-V3 launch factory.
...
contract ArcForgeFactory is Ownable2Step, Pausable, ReentrancyGuard {
    ...
    function launchToken(
        ...
        ArcForgeToken launchedToken = new ArcForgeToken{salt: tokenSalt}(
            params.name,
            params.symbol,
            TOTAL_SUPPLY,
            msg.sender,
