...
import {IArcForgeFeeVault} from "./interfaces/IArcForgeFeeVault.sol";

/// @notice Authorized fee accounting and Safe-controlled treasury vault for ArcOrigin.
contract ArcForgeFeeVault is Ownable2Step, ReentrancyGuard, IArcForgeFeeVault {
    ...
    /// @notice Lets an authorized Factory register its immutable fee collectors.
