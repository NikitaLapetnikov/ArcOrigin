...
/// @notice Permanently holds V7 launch LP NFTs and permissionlessly distributes LP fees.
/// @dev There is intentionally no NFT transfer, approval, liquidity decrease, burn, rescue,
///      or administrative mutation path.
contract ArcOriginUniswapV3LaunchLockerV7 is IERC721Receiver, ReentrancyGuard {
