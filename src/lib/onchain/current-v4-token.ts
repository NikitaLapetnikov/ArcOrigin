import { ARCORIGIN_ACTIVE_GRADUATION_TARGET_USDC, ARC_ACTIVE_FACTORY } from "@/lib/chains";
import type { TokenData } from "@/lib/types";

export function isCurrentV4Token(token: TokenData) {
  return token.factoryAddress?.toLowerCase() === ARC_ACTIVE_FACTORY.toLowerCase()
