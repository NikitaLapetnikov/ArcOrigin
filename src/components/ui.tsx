...
export function PageIntro({ eyebrow, title, body, children }: { eyebrow: string; title: string; body: string; children?: ReactNode }) {
  return <div className="container-shell pb-7 pt-10 md:pb-10 md:pt-14"><div className="max-w-[680px]"><p className="eyebrow mb-3">{eyebrow}</p><h1 className="text-[34px] font-semibold leading-[1.08] tracking-[-.05em] text-white sm:text-[42px] md:text-[50px]">{title}</h1><p className="mt-4 max-w-xl text-[15px] leading-7 text-slate-400">{body}</p>{children}</div></div>;
}
